...
for count, dir in enumerate(files_dir, 1):
    ...
    if not os.path.exists(path + '/' + dir):
        os.mkdir(path + '/' + dir)
    if not os.path.exists(path_aug + '/' + dir):
        os.mkdir(path_aug + '/' + dir)
    ...
    for i in images_files:
        ...
        if ext == '.jpg':
            ...
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_90' +'.jpg', color_img_rotate_90_clockwise)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_90' +'.png', depth_img_rotate_90_clockwise)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_180' +'.jpg', color_img_rotate_180_clockwise)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_180' +'.png', depth_img_rotate_180_clockwise)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_270' +'.jpg', color_img_rotate_270_clockwise)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_270' +'.png', depth_img_rotate_270_clockwise)
            ...
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_ud' +'.jpg', color_img_flip_ud)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_ud' +'.png', depth_img_flip_ud)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_lr' +'.jpg', color_img_flip_lr)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_lr' +'.png', depth_img_flip_lr)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_udlr' +'.jpg', color_img_flip_udlr)
            cv2.imwrite(path_aug + '/' + dir + '/' + base + '_flip_udlr' +'.png', depth_img_flip_udlr)
